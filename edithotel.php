                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-15">
                            ...
                            if (isset($_POST['Edit'])) {
                                ...
                                mysqli_query($connection, "update hotel set hotelKODE='$hotelKODE', hotelNAMA='$hotelNAMA', hotelALAMAT='$hotelALAMAT', kategoriKODE='$kategoriKODE'
        ...
        <div class="col-sm-10">
            <form method="POST">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="hotelKODE" name="hotelKODE" placeholder="Kode Hotel" value="<?php echo $rowedit ["hotelKODE"]?>"readonly>
                    </div>
                </div>
