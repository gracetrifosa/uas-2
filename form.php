                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-15">
                            ...
                            if (isset($_POST['Simpan'])) {
                                ...
                                mysqli_query($connection, "INSERT INTO form VALUES ('$user_id', '$firstname', '$lastname', '$berita')");
                            }
                            ?>
                                ...
                                <div class="col-sm-10">
                                    <form method="POST">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="exampleFormControlInput1" name="userid" placeholder="Kode Berita">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            <label for="nberita" class="col-sm-2 col-form-label">Berita</label>
                                            <div class="col-sm-10">
        ...
        <table class="table table-hover table-secondary">
            <thead>
                <tr>
                    ...
                    <td width="5px">                      
                        <a href="editform.php?ubah=<?php echo $row["user_id"]?>"
