                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            if (isset($_POST['Simpan'])) {
                                ...
                                // connect database
                                $koneksi = mysqli_query($connection, "INSERT INTO travel VALUES ('$nama', '$alamat', '$tanggal', '$destinasi', '$namaresto', '$fotoFILE')");
                            }
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="POST">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Masukkan Nama Travel" name="nama">
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control" name="namaresto" id="namaresto">
                                                            <option value="">Pilih Restoran</option>
                                                            <?php
                                                            $datakategori = mysqli_query($connection, "SELECT * FROM restaurant");
                                                            while ($row = mysqli_fetch_array($datakategori)) {
                                                            ?>
                                                                <option value="<?php echo $row["namaresto"] ?>">
                                                                    <?php echo $row["namaresto"] . ' - ' . $row["namaresto"] ?>
                                                                </option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                    ...
                                    <div class="col-md-6 mx-auto">
                                        <form method="POST">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" name="search" placeholder="Cari Nama Travel" value="<?php if(isset($_POST['search'])) {echo $_POST['search'];}?>">
                                    ...
                                    <table class="table table-info table-striped table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="5px">
                                                    <a href="edittravel.php?ubah=<?php echo $row["nama"]?>" class="btn btn-success btn-sm" title="edit">
