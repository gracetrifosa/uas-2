                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-15">
                            <div class="jumbotron jumbotron-fluid">
                                <div class="container">
                                    <h1 class="display-10">Restaurant</h1>
                                </div>
                            </div>
                            ...
                            if (isset($_POST['Simpan'])) {
                                ...
                                mysqli_query($connection, "INSERT INTO restaurant VALUES ('$nama', '$namaresto', '$tanggal', '$waktu', '$fotoFILE')");
                            }
...
<body>
                    ...
                    <input type="file" id="file" name="fotoFILE">
                                  ...
                                  <div class="mb-3">
                                                    <label for="kodekategori" class="col-sm-2 col-form-label">Destinasi</label>
                                                    <div class="col-sm-10">
                                                        <select class="form-control" name="kodekategori" id="kodekategori">
                                                            ...
                                                            ?>
                                                                <option value="<?php echo $row["destinasiKODE"] ?>">
                                                                    <?php echo $row["destinasiKODE"] . ' - ' . $row["destinasiNAMA"] ?>
                                                                </option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                    ...
                    $search = $_POST['search'];
                    $query = mysqli_query($connection, "SELECT * FROM restaurant WHERE namaRESTO  LIKE '%" . $search . "%'");
                    } else {
                ...
                <?php } else {
                    ...
                    <td width ="5px">
                    <a href="hapusrestaurant.php?hapus=<?php echo $row["nama"]?>" class="btn btn-danger btn-sm" title="hapus">
