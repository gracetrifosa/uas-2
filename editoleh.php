    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <h1 class="mt-4">Edit Oleh-Oleh</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-15">
                            ...
                            if (isset($_POST['Edit'])) {
                                ...
                                $fotoolehFILE = $_POST['fotooleh'];
                                $file_tmp=$_FILES["file"]["tmp_name"];

                                mysqli_query($connection, "update oleholeh set olehNAMA='$olehNAMA', olehJENIS='$olehJENIS', fotoolehFILE='$fotoolehFILE'
                                where olehKODE='$olehKODE'");
                                    header("location:oleholeh.php");
                        }

                        $olehKODE = $_GET["ubah"];
                        $editoleh= mysqli_query ($connection, "select * from oleh
                        where olehKODE = '$olehKODE'");
                ...
                <div class="card mb-3">
                    ...
                    Oleh-Oleh Khas Terkini
                            ...
                            <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="exampleFormControlInput1" name="kodeoleh" placeholder="Kode Oleh-Oleh" value="<?php echo $rowedit ["olehKODE"]?>"re>
                                            </div>
                                        </div>
            ...
            <div class="card mb-3">
                <div class="card-header text-white bg-dark">
                    ...
                    <td>
                    <?php
if (!empty($row) && isset($row['fotoolehFILE'])) {
    $imagePath = "images/" . $row['fotoolehFILE'];

    if (is_file($imagePath)) {
        echo "<img src='$imagePath' width='80'>";
    } else {
