            ...
            <main>
                ...
                <h1 class="mt-4">Edit Restaurant</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-15">
                            ...
                            if (isset($_POST['Edit'])) {
                                ...
                                mysqli_query($connection, "update restaurant set nama='$nama', namaresto='$namaresto', tanggal='$tanggal', waktu='$waktu', fotoFILE='$fotoFILE'
                                where nama='$nama'");
                                    header("location:restaurant.php");
                        }

                        $nama = $_GET["ubah"];
                        $editrestaurant= mysqli_query ($connection, "select * from restaurant
                        where nama = '$nama'");
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" class="form-control" placeholder="Masukkan Nama" name="nama" value="<?php echo $rowedit ["nama"]?>"readonly>
                            </div>

                            <div class="mb-3">
                            <label class="form-label">Nama Resto</label>
                            <input type="text" class="form-control" placeholder="Masukkan Nama Resto" name="namaresto">
                            </div>
                    ...
                    <div class="card text mt-4 mb-4">
                                <div class="card-header bg-dark text-white">
                                    Restaurant Input Results
                        </div>
                        <div class="card-body">
                            <div class="col-md-6 mx-auto">
                                <form method="POST">
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="search" placeholder="Cari Nama Resto"
                    ...
                    $search = $_POST['search'];
                    $query = mysqli_query($connection, "SELECT * FROM restaurant WHERE restaurant  LIKE '%" . $search . "%'");
                    } else {
                ...
                <?php } else {
                    ...
                    <td width="5px">                      
                        <a href="editrestaurant.php?ubah=<?php echo $row["nama"]?>"
                        ...
                        <td width="5px">
                        <a href="hapusrestaurant.php?hapus=<?php echo $row["nama"]?>"
