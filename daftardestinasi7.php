                                    ...
                                    <form method="POST">
                                        <div class="mb-3">
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="search" class="form-control" id="search" value="<?php if (isset($_POST['search'])) {echo $_POST['search'];}?>" placeholder="Cari Kode Hotel">
                                                </div>
                                                <div class="col-sm-1">
                                    ...
                                    <table class="table table-hover table-warning">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST["kirim"])) {
                                                $search = $_POST['search'];
                                                $query = mysqli_query($connection, "SELECT * FROM hotel WHERE nama LIKE '%" . $search . "%'");
                                            } else {
