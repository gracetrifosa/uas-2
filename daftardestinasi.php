...
?>
    ...
    <div class="mb-3">
        <div class="form-group row mb-2">
            <label for="search" class="col-sm-3">Kode Kategori</label>
            <div class="col-sm-6">
                <input type="text" name="search" class="form-control" id="search" value="<?php if (isset($_POST['search'])) {echo $_POST['search'];}?>" placeholder="Cari Kode Kategori">
            </div>
            <div class="col-sm-1">
                <!-- Perubahan disini: -->
  ...
  <thead>
    <tr>
      ...
      <th scpe="col">Keterangan Kategori</th>
      <th scpe="col">Referensi Kategori</th>
    </tr>
  </thead>
  <tbody>
    <?php 
    if (isset($_POST["kirim"])) {
        $search = $_POST['search'];
        $query = mysqli_query($connection, "SELECT * FROM kategoriwisata WHERE kategoriKODE LIKE '%" . $search . "%'");
    } else {
